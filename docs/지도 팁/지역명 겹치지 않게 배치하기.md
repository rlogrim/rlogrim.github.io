...
<img src="{{ site.baseurl }}/assets/images/지역명-겹치지-않게-배치하기/unnamed-chunk-1-1.png" width="100%" style="display: block; margin: auto;" alt="수도권 시군구를 나타낸 지도" />
...
<img src="{{ site.baseurl }}/assets/images/지역명-겹치지-않게-배치하기/unnamed-chunk-2-1.png" width="100%" style="display: block; margin: auto;" alt="geom_text_repel로 수도권 시군구명 분산 배치한 지도" />
...
<img src="{{ site.baseurl }}/assets/images/지역명-겹치지-않게-배치하기/unnamed-chunk-3-1.png" width="100%" style="display: block; margin: auto;" alt="일부 지역명 생략한 수도권 지도" />
