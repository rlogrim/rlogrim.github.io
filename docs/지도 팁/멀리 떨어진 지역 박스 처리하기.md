...
지도를 그릴 때, 서로 멀리 떨어진 지역이 포함될 경우 전체적인 비율과
구성이 왜곡될 수 있습니다. 예를 들어, 수도권 지도를 그리면 옹진군은
육지에서 크게 떨어져 있어 지도의 중심에서 벗어나고, 육지 부분이 작아
보이게 됩니다. 이러한 문제를 해결하기 위해 본 글에서는 멀리 떨어진
지역을 별도의 박스로 표시하여 메인 지도에 추가하는 방법을 소개합니다.
