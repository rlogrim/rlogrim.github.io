...
<img src="{{ site.baseurl }}/assets/images/시간에-따른-변화-시각화하기/unnamed-chunk-3-1.png" width="100%" style="display: block; margin: auto;" alt="1995년, 2023년 서울 구별 주민등록인구 수 변화를 나타낸 지도" />
...
<img src="{{ site.baseurl }}/assets/images/시간에-따른-변화-시각화하기/unnamed-chunk-4-1.png" width="100%" style="display: block; margin: auto;" alt="1995년, 2023년 서울 구별 주민등록인구 수 변화를 나타낸 지도 테마 수정" />
