...
경우에 따라 y축을 데이터 중간부터 시작하고 싶을 때가 있습니다.

예를 들어, 비교하고자 하는 값들이 큰 차이가 없는 경우, y축이 0부터
시작하면 중요한 차이를 제대로 드러내기 어렵습니다.

이럴 때는 y축의 범위를 데이터의 중간값이나 원하는 구간으로 조정하면
됩니다.

이를 위해 `coord_cartesian` 함수를 사용합니다.
...
오늘 다룬 y축 범위 조정 팁을 활용해 데이터를 더 명확히 전달할 수 있는
그래프를 만들어 보세요 😊
