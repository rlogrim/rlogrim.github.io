...
<img src="{{ site.baseurl }}/assets/images/숫자-포맷팅/unnamed-chunk-2-1.png" width="70%" style="display: block; margin: auto;" alt="숫자 세 자리마다 콤마를 추가한 그래프" />
...
<img src="{{ site.baseurl }}/assets/images/숫자-포맷팅/unnamed-chunk-3-1.png" width="70%" style="display: block; margin: auto;" alt="숫자를 백분율로 변환하고 소수점 한 자리까지 표기한 그래프" />
...
<img src="{{ site.baseurl }}/assets/images/숫자-포맷팅/unnamed-chunk-4-1.png" width="70%" style="display: block; margin: auto;" alt="막대그래프와 선그래프를 합친 그래프" />
