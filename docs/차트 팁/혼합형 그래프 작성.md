...
<img src="{{ site.baseurl }}/assets/images/혼합형-그래프-작성/unnamed-chunk-3-1.png" width="70%" style="display: block; margin: auto;" alt="년도별 승객 수를 나타내는 막대그래프" />
...
<img src="{{ site.baseurl }}/assets/images/혼합형-그래프-작성/unnamed-chunk-4-1.png" width="70%" style="display: block; margin: auto;" alt="년도별 승객 수를 나타내는 막대그래프에 전년 대비 승객 수 증감률을 나타내는 선그래프 추가" />
...
<img src="{{ site.baseurl }}/assets/images/혼합형-그래프-작성/unnamed-chunk-5-1.png" width="70%" style="display: block; margin: auto;" alt="선그래프 위치를 조정한 그래프" />
...
<img src="{{ site.baseurl }}/assets/images/혼합형-그래프-작성/unnamed-chunk-6-1.png" width="70%" style="display: block; margin: auto;" alt="보조축을 추가한 그래프" />
...
<img src="{{ site.baseurl }}/assets/images/혼합형-그래프-작성/unnamed-chunk-7-1.png" width="70%" style="display: block; margin: auto;" alt="범례를 추가한 그래프" />
