...
<img src="{{ site.baseurl }}/assets/images/막대그래프-오름차순-정렬/unnamed-chunk-1-1.png" width="70%" style="display: block; margin: auto;" alt="Iris 품종별 꽃받침 너비를 비교한 그래프" />
...
<img src="{{ site.baseurl }}/assets/images/막대그래프-오름차순-정렬/unnamed-chunk-2-1.png" width="70%" style="display: block; margin: auto;" alt="내림차순 정렬한 막대그래프" />
...
<img src="{{ site.baseurl }}/assets/images/막대그래프-오름차순-정렬/unnamed-chunk-3-1.png" width="70%" style="display: block; margin: auto;" alt="오름차순 정렬한 막대그래프" />
...
<img src="{{ site.baseurl }}/assets/images/막대그래프-오름차순-정렬/unnamed-chunk-4-1.png" width="70%" style="display: block; margin: auto;" alt="내림차순 정렬한 막대그래프의 x축 제목 수정" />
