...
<img src="{{ site.baseurl }}/assets/images/색상으로-특정-값-강조하기/unnamed-chunk-3-1.png" width="100%" style="display: block; margin: auto;" alt="2023년 서울시 구별 주민등록인구수 막대그래프" />
...
<img src="{{ site.baseurl }}/assets/images/색상으로-특정-값-강조하기/unnamed-chunk-4-1.png" width="100%" style="display: block; margin: auto;" alt="상위 3개 구를 강조한 2023년 서울시 구별 주민등록인구수 막대그래프" />
...
<img src="{{ site.baseurl }}/assets/images/색상으로-특정-값-강조하기/unnamed-chunk-5-1.png" width="100%" style="display: block; margin: auto;" alt="테마를 조정한 2023년 서울시 구별 주민등록인구수 최종 그래프" />
