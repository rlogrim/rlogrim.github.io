...
<img src="{{ site.baseurl }}/assets/images/스파이더차트-그리기/삼각함수를 이용한 좌표 구하는 법.jpg" width="50%" style="display: block; margin: auto;" alt="삼각함수를 이용한 좌표 구하는 법" />
...
<p style="text-align: center;"><i>scaled = (x - x<sub>min</sub>)/(x<sub>max</sub> - x<sub>min</sub>)·(1 - 0.2) + 0.2</i></p>
...
<img src="{{ site.baseurl }}/assets/images/스파이더차트-그리기/스파이더차트에서 r과 n의 의미.jpg" width="50%" style="display: block; margin: auto;" alt="스파이더차트에서 r과 n의 의미" />
...
<img src="{{ site.baseurl }}/assets/images/스파이더차트-그리기/unnamed-chunk-5-1.png" width="100%" style="display: block; margin: auto;" alt="스파이더차트 배경" />
...
<img src="{{ site.baseurl }}/assets/images/스파이더차트-그리기/unnamed-chunk-8-1.png" width="100%" style="display: block; margin: auto;" alt="축을 추가한 스파이더차트 배경" />
...
<img src="{{ site.baseurl }}/assets/images/스파이더차트-그리기/unnamed-chunk-10-1.png" width="100%" style="display: block; margin: auto;" alt="데이터를 추가하여 완성한 스파이더차트" />
